...
urlpatterns = [
    ...
    # Vérification OTP
    path('verification/<int:utilisateur_id>/<str:objet>/', views.verifier_otp, name='verifier_otp'),
    path('renvoyer-otp/<int:utilisateur_id>/<str:objet>/', views.renvoyer_otp, name='renvoyer_otp'),
